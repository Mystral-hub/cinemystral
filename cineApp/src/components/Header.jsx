...
export const Header = () => {
  ...
  return (
    <header>
      <nav className="dark:bg-[rgb(3,3,51)] dark:text-gray-200 bg-neutral-primary sticky w-full z-20 top-0 start-0 border-b border-default">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link
            to="/"
            className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src={Logo} className="h-12 rounded-full" alt="MystralLogo" />
          ...
          <div
            className={`${onMobile ? "" : "hidden"} items-center justify-between w-full md:flex md:w-auto md:order-1`}
            id="navbar-search">
